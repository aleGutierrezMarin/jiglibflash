package jiglib.debug
{
	...
	{	
		...
		private var physics			: Away3D4Physics; // TODO only away3d4 atm
		private var view3d			: View3D; // TODO only away3d4 atm
		...
		public function Stats(view3d:View3D,physics:Away3D4Physics,grid:Boolean = false) : void
		{
			...
			addTextField(textFpsLabel,0xFFFFFF,10,true,TextAlign.LEFT,1,10,10);
			addTextField(textFps,0x1abfff,10,true,TextAlign.LEFT,1,40,10);
			addTextField(textMsLabel,0xFFFFFF,10,true,TextAlign.LEFT,1,96,10);
			addTextField(textMs,0xffcc1a,10,true,TextAlign.LEFT,1,135,10,44);
			addTextField(textBottomLeft,0x000000,10,true,TextAlign.RIGHT,6,10,65,80,36);
			addTextField(textBottomRight,0x000000,10,true,TextAlign.LEFT,6,88,65,80,36);
			addTextField(textBottom,0x000000,10,true,TextAlign.CENTER,0,10,101,160,14);

			// headers
			textFpsLabel.htmlText = "FPS:<br>CDC:<br>TRI.:";
			textMsLabel.htmlText = "TOTAL:<br>JIGLIB:<br>3D:";
			textBottom.htmlText = "CDT BRUTEFORCE"; // TODO once we got a grid system
